...
public static unsafe partial class Ttf {
    ...
    public unsafe struct TextData {
        ...
        public SubString* Clusters;    /**< Substrings representing clusters of glyphs in the string, read-only */
        ...
        public nint Engine;     /**< The engine used to render this text, read-only. */
        public nint EngineText;          /**< The implementation-specific representation of this text */
    };
}