...
public static unsafe partial class Sdl {
    ...
    public static bool EventEnabled(uint type) {
        ...
        return type == 0 ? throw new ArgumentException("Event type cannot be zero.", nameof(type)) :
    ...
    public static bool HasEvents(uint minType, uint maxType) {
        ...
        return minType > maxType ? throw new ArgumentException("minType cannot be greater than maxType.", nameof(minType)) :
            // Call the native method and return the result
    ...
    public static uint RegisterEvents(int numEvents) {
        ...
        return numEvents <= 0 ? throw new ArgumentOutOfRangeException(nameof(numEvents), "Number of events must be greater than zero.") :
            // Call the native method and return the result
            SDL_RegisterEvents(numEvents);
    }
