...
public static partial class Mouse {
    ...
    public static bool WarpMouseGlobal(float x, float y) {
        ...
        if (!result) {
            Logger.LogError(LogCategory.System, "Failed to warp mouse globally.");
        }
    ...
    public static bool SetWindowRelativeMouseMode(nint window, bool enabled) {
        ...
        if (!result) {
            Logger.LogError(LogCategory.System, $"Failed to set relative mouse mode for the specified window. {GetError()}");
        }
    ...
    public static bool GetWindowRelativeMouseMode(nint window) {
        ...
        if (!result) {
            Logger.LogError(LogCategory.System, $"Failed to retrieve relative mouse mode for the specified window. {GetError()}");
        }
    ...
    public static bool CaptureMouse(bool enabled) {
        ...
        if (!result) {
            Logger.LogError(LogCategory.System, "Failed to capture mouse.");
        }
    ...
    public static bool SetCursor(nint cursor) {
        ...
        if (!result) {
            Logger.LogError(LogCategory.System, "Failed to set the specified cursor.");
        }
