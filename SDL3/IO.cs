...
namespace SDL3 {
    public static partial class IO {
        ...
        public static nint LoadFile(string file, out nuint datasize) {
            nuint ds = 0; // Initialize the variable to avoid CS0165
            nint result = SDL_LoadFile(file, out ds);
            if (result == 0) {
        ...
        public static nint LoadFileIO(nint src, out nuint datasize, SdlBool closeio) {
            nuint ds = 0; // Initialize the variable to avoid CS0165
            nint result = SDL_LoadFile_IO(src, out ds, closeio);
            if (result == 0) {
        ...
        public static SdlBool ReadS16BE(nint src, out short value) {
            short v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS16BE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadS16LE(nint src, out short value) {
            short v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS16LE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadS32BE(nint src, out int value) {
            int v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS32BE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadS32LE(nint src, out int value) {
            int v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS32LE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadS64BE(nint src, out long value) {
            long v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS64BE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadS64LE(nint src, out long value) {
            long v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS64LE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadS8(nint src, out sbyte value) {
            sbyte v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadS8(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU16BE(nint src, out ushort value) {
            ushort v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU16BE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU16LE(nint src, out ushort value) {
            ushort v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU16LE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU32BE(nint src, out uint value) {
            uint v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU32BE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU32LE(nint src, out uint value) {
            uint v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU32LE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU64BE(nint src, out ulong value) {
            ulong v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU64BE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU64LE(nint src, out ulong value) {
            ulong v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU64LE(src, out v);
            if (!result) {
        ...
        public static SdlBool ReadU8(nint src, out byte value) {
            byte v = 0; // Initialize the variable to avoid CS0165
            SdlBool result = SDL_ReadU8(src, out v);
            if (!result) {
